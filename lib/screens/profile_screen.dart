              ...
              : Padding(
                  ...
                  child: ListView(
                    children: [
                      ...
                      _buildProfileField('Contact 1', '${_userProfile!['emergency_contact_1_name']} (${_userProfile!['emergency_contact_1_relation']})'),
                      _buildProfileField('Contact 1 Number', _userProfile!['emergency_contact_1_number']),
                      _buildProfileField('Contact 2', '${_userProfile!['emergency_contact_2_name']} (${_userProfile!['emergency_contact_2_relation']})'),
